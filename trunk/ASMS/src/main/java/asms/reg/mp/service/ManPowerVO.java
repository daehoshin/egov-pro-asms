 ...
 * @FileName ManPowerVO.java
 * @Author DAE.HO.SHIN
 * @Since 2016. 4. 9.
 */
public class ManPowerVO extends PagingVO{
	
	private String mp_id;			// 인력ID
	private String[] mp_id_array;	// 인력ID 배열
	...
	private String use_flag_cm;		// 사용여부코드값
	...
	private String mp_cd_cm;       	// 인력CD코드값
	...
	private String emp_cd_cm;      	// 근무유형코드값
	private String join_cd;        	// 재직유무      
	private String join_cd_cm;     	// 재직유무코드값      
	...
	public String[] getMp_id_array() {
		return mp_id_array;
	}
	public void setMp_id_array(String[] mp_id_array) {
		this.mp_id_array = mp_id_array;
	}
