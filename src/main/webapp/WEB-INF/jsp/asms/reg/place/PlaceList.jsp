...
//정렬
function jsPlaceListSort(orderColumnValue){
		           ...
		           <table class="table table-striped table-bordered table-hover" >
		            <thead>
			            <tr>
			                ...
			                <th class="widthP25 textCenter"><a href="javascript:jsPlaceListSort('PLC_NM');">장소명</a>
			                ${placeVO.orderColumn eq "PLC_NM" ? placeVO.orderType eq "ASC" ? sAscSortImg : sDescSortImg : "" }
			                </th>
			                <th class="widthP35 textCenter"><a href="javascript:jsPlaceListSort('FULL_ADDR');">주소</a>
			                ${placeVO.orderColumn eq "FULL_ADDR" ? placeVO.orderType eq "ASC" ? sAscSortImg : sDescSortImg : "" }
			                </th>
			                <th class="widthP10 textCenter"><a href="javascript:jsPlaceListSort('REG_NM');">등록자</a>
			                ${placeVO.orderColumn eq "REG_NM" ? placeVO.orderType eq "ASC" ? sAscSortImg : sDescSortImg : "" }
			                </th>
			                <th class="widthP10 textCenter"><a href="javascript:jsPlaceListSort('REG_STATUS');">등록상태</a>
