...
<div class="modal-dialog modal-sm">
	<div class="modal-content">
        ...
        <form id="equipmentDelForm" name="equipmentDelForm" class="form-horizontal" method="post">
...
function jsDelRsnSave() {
	$("#equipmentDelForm").attr("action","${executeUrl}").submit()
}

function jsDelSaveAction() {
	
	var delForm = $("form[name='equipmentDelForm']").serialize();
