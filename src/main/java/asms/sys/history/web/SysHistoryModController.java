...
@Controller
public class SysHistoryModController {
	
	@Resource(name = "HistoryService")
	protected HistoryService historyService;
	 
	@RequestMapping("/sys/history/historyModForm.do")
	public String SysHistoryModForm(@RequestParam("history_id")String history_id, ModelMap map) throws Exception{
