...
@Controller
public class SysCodeModController {
	
	@Resource(name = "CodeService")
	protected CodeService codeService;
	 
	@RequestMapping("/sys/code/codeModForm.do")
	public String SysCodeModForm(@RequestParam("code_id")String code_id, ModelMap map) throws Exception{
